...
public class LuxChargerMenu extends AbstractContainerMenu {
    ...
    public LuxChargerMenu(int id, Inventory playerInv, LuxChargerBlockEntity entity, net.minecraft.world.inventory.ContainerData data) {
    ...
    public int getChargeProgress() {
        ...
        return total != 0 && current != 0 ? current * 24 / total : 0; // Scale to arrow size (24 pixels)
    }
}
